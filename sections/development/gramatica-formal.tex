...
La elección de una gramática formal como primera técnica responde a una motivación deliberada. Una gramática ofrece determinismo (la misma entrada produce siempre la misma salida), transparencia (cada transformación lingüística está codificada explícitamente y puede inspeccionarse) e independencia de servicios externos. Estas propiedades la convierten en una base de comparación sólida frente a las técnicas estadísticas y neuronales que se exploran en capítulos posteriores. La filosofía de diseño que guía esta técnica prioriza la corrección gramatical sobre la cobertura: en un contexto donde el usuario depende del sistema para comunicarse, es preferible rechazar una entrada no soportada a generar una frase incorrecta que distorsione su intención.
