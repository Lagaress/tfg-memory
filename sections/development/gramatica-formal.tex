Una gramática libre de contexto (CFG, por \textit{Context-Free Grammar}) es un formalismo que describe la estructura de un lenguaje mediante un conjunto finito de reglas de producción. Cada regla descompone un símbolo abstracto en una secuencia de símbolos más concretos, y aplicándolas recursivamente se obtienen todas las cadenas válidas del lenguaje. Noam Chomsky propuso este formalismo en 1957~\cite{chomsky1957syntactic} como modelo de la capacidad sintáctica humana, y desde entonces se ha convertido en una herramienta habitual tanto en el diseño de lenguajes de programación como en la lingüística computacional. En el ámbito de la generación de texto, una CFG permite definir las estructuras oracionales válidas de un idioma: por ejemplo, una regla como $O \rightarrow SN\ SV$ establece que una oración ($O$) se compone de un sintagma nominal ($SN$) seguido de un sintagma verbal ($SV$), y reglas posteriores especifican que el sintagma nominal puede ser un determinante seguido de un sustantivo ($SN \rightarrow Det\ N$) o que el sintagma verbal contiene un verbo y un complemento ($SV \rightarrow V\ SN$). Con estas reglas, dada una entrada léxica, el sistema puede construir automáticamente oraciones que respetan la estructura sintáctica del idioma.
