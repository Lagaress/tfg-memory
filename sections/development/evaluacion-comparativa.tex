...
Métrica & Gramática & LLM & & Híbrido 1 & Híbrido 2 & Híbrido 3 \\
\hline
Perplejidad & 161 & 162 & & 100 & 102 & 151 \\
Pseudo-perpl. & 33 & 34 & & 18 & 18 & 32 \\
Cobertura & 0,972 & 0,971 & & 0,983 & 0,980 & 0,986 \\
Fidelidad & 0,918 & 0,920 & & 0,936 & 0,934 & 0,933 \\
Latencia (ms) & 0,02 & 1643 & & 811 & 915 & 4279 \\
...
Los diagramas de caja de la Figura~\ref{fig:eval-boxplots} complementan las medias de la tabla anterior mostrando la distribución completa de cada métrica. La gramática formal y los embeddings aparecen como líneas sin dispersión, consecuencia de sus scores perfectos. El LLM y los tres híbridos comparten un perfil similar: la mayoría de las observaciones se concentran en valores altos (Exact Match del 85-88\%), con una cola izquierda de casos donde las reformulaciones divergen de la referencia. La dispersión del LLM (desviación estándar de 0,36 en Exact Match) es comparable a la de los híbridos.
...
\hline
Latencia & $<$1 ms & $<$1 ms & $\sim$1643 ms & $\sim$811 ms & $\sim$915 ms & $\sim$4,3 s \\
...
La convergencia n-gramática entre motores merece atención. En 343 de los 428 casos (80,1\%), los seis motores producen exactamente la misma salida, lo que reduce el tamaño efectivo de la muestra para las comparaciones estadísticas a 85 casos en métricas de coincidencia. La alta redundancia entre las métricas de coincidencia (BLEU-4, METEOR, chrF++, ROUGE-L, Exact Match, BERTScore correlacionan con $r > 0{,}92$) confirma que miden esencialmente la misma dimensión; BLEU-4 se utiliza como métrica principal por ser la más establecida en la literatura de NLG.
