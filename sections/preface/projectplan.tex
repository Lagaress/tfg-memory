...
La aplicación móvil y el servidor cuentan también con pruebas unitarias que cubren la lógica de construcción de frases en el tablero de pictogramas, el cliente del servicio de generación y los \textit{endpoints} REST expuestos. El uso de TypeScript en la aplicación proporciona además tipado estático que detecta inconsistencias en tiempo de compilación, y el servidor implementa \textit{endpoints} de salud (\textit{liveness} y \textit{readiness}) que permiten verificar automáticamente si el servicio está operativo y si los motores de generación están cargados y listos para procesar peticiones.
