...
La última etapa del flujo es la síntesis de voz. La app combina dos motores complementarios: un servicio neuronal externo como motor principal cuando hay conexión a Internet y los motores nativos de la plataforma como respaldo \textit{offline}. Esta duplicidad responde a un principio fundamental en CAA: un usuario que depende del dispositivo para comunicarse no puede quedarse sin voz porque falle la red.
