Este anexo recoge los extractos de código más representativos del motor de gramática formal descrito en el capítulo correspondiente. Los fragmentos se presentan en el orden en que intervienen en el pipeline de generación, desde las estructuras de datos hasta la lógica de transformación. El código completo del motor comprende 4.355 líneas distribuidas en siete archivos (véase la Tabla~\ref{tab:f1-codigo}).
