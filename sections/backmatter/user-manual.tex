...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/app/04-pantalla-inicial.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/app/05-modal-nuevo-pictograma.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/app/06-hablar-antes.png}
    \hfill
    \includegraphics[width=0.9\textwidth]{figures/app/07-hablar-despues.png}
